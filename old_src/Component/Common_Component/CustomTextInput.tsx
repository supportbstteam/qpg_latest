...
const CustomTextInput: React.FC<CustomTextInputProps> = ({ title, value, placeholder, onChangeText, keyboardType = 'default', secureTextEntry = false, maxLength,editable ,...rest }) => {
    return (
