...
import ManageReport from '../Screen/ManageReport/ManageReport';
import ExpensesListing from '../Screen/Manage Expenses/ExpensesListing';
import Manage_Team from '../Screen/ManageTeam/Manage_Team';
      ...
      {userRole !== 3 && userRole !== 4 ? (
        <>
          ...
          <Drawer.Screen
            ...
            options={{
              drawerIcon: ({ focused, color, size }) => (
                <Icon name="file-text" color={'#ffffff'} size={30} />
              ),
            }}
          />
          ...
          <Drawer.Screen
            ...
            options={{
              drawerIcon: ({ focused, color, size }) => (
                <Icon name="box" color={'#ffffff'} size={30} />
              ),
            }}
          />
